...
function(add_rust_library)
    ...
    if (${ARGS_SHARED})
        set(MY_TARGET_NAME "${CMAKE_SHARED_LIBRARY_PREFIX}${ARGS_TARGET}${CMAKE_SHARED_LIBRARY_SUFFIX}")
        set(MY_LIB_NAME "${CMAKE_SHARED_LIBRARY_PREFIX}${ARGS_TARGET}${CMAKE_SHARED_LIBRARY_SUFFIX}")
        if(WIN32)
            set(MY_LIB_NAME "${ARGS_TARGET}.dll.lib")
        endif()
    else()
        set(MY_TARGET_NAME "${CMAKE_STATIC_LIBRARY_PREFIX}${ARGS_TARGET}${CMAKE_STATIC_LIBRARY_SUFFIX}")
        set(MY_LIB_NAME "${CMAKE_STATIC_LIBRARY_PREFIX}${ARGS_TARGET}${CMAKE_STATIC_LIBRARY_SUFFIX}")
    endif()
